...
if __name__ == '__main__':
    img_path = './ICDAR_2015/test_img/5350046-2004-0001-0392.JPG'
    ...
    model = detectionModel(num_class)
    model = torch.nn.DataParallel(model).to(device)
    print('loading pretrained model from %s' % './pths/best_accuracy.pth')
    model.load_state_dict(torch.load('./pths/best_accuracy.pth', map_location=device))
